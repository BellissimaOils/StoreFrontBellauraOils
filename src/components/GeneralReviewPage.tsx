            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border-2 border-purple-300 bg-[#f8f5fc] p-3.5 mt-4 rounded-xl text-sm text-primary-earth focus:border-purple-600 focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-200 transition-all duration-200 placeholder:text-purple-900/40 shadow-2xs"
                />
              </div>
